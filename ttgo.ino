 ...
 *   inspirÃ© de : https://github.com/SFeli/ESP32_S8
 * 
 ***********************************************/
...
byte disableABC[] = {0xFE, 0X06, 0X00, 0X1F, 0X00, 0X00, 0XAC, 0X03};  
byte enableABC[] = {0xFE, 0X06, 0X00, 0X1F, 0X00, 0XB4, 0XAC, 0X74}; 
byte clearHR1[] = {0xFE, 0X06, 0X00, 0X00, 0X00, 0X00, 0X9D, 0XC5}; 
byte HR1req[] = {0xFE, 0X03, 0X00, 0X00, 0X00, 0X01, 0X90, 0X05}; 
byte calReq[] = {0xFE, 0X06, 0X00, 0X01, 0X7C, 0X06, 0X6C, 0XC7}; 
byte Response[20];
uint16_t crc_02;
int ASCII_WERT;
...
// interruption pour lire le bouton d'Ã©talonnage
...
// nettoie l'Ã©cran et affiche les infos utiles
void prepareEcran() {
  tft.fillScreen(TFT_BLACK);
  // texte co2 Ã  gauche
  tft.setTextSize(4);
  ...
  // texte PPM Ã  droite ppm
  tft.drawString("ppm",190, 105);

  // Ã©criture du chiffre
...
void setup() {
  ...
  // ports sÃ©rie de debug et de communication capteur
  Serial.begin(115200);
  ...
  // active ou dÃ©sactive l'ABC au dÃ©marrage
...
void loop() {
  ...
  // effectue l'Ã©talonnage si on a appuyÃ© sur le bouton
